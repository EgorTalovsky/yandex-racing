    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                System.out.println("- Максимальная скорость: " + generateOpponentCar().maxSpeed);
                System.out.println("- Ускорение: " + generateOpponentCar().acceleration);
                System.out.println("- Закись азота: " + generateOpponentCar().nitroLevel);
